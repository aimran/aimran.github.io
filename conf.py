...
BLOG_AUTHOR = "Asif Imran"  # (translatable)
BLOG_TITLE = "Asif Imran"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://aimran.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "covariantmonkey@gmail.com"
...
SOCIAL_LINKS = (
    ('Github', 'http://github.com/aimran', 'fa-github'),
    ('Twitter', 'http://twitter.com/5sigma', 'fa-twitter'),
    ('LinkedIn', 'http://www.linkedin.com/pub/asif-imran/60/523/6a1','fa-linkedin')
)
...
# (translatable)
CONTENT_FOOTER = '&copy; <a href="mailto:{email}">{author}</a>  {date} -  Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
